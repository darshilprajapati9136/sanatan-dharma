...
const TOPICS = [
  ['temples-traditions', 'temple-traditions'],
  ['temples-traditions', 'pilgrimage-sites']
] as const;
...
export async function generateMetadata({
  ...
  return {
    title: t('categories.temples-traditions.title'),
    description: t('categories.temples-traditions.description')
  };
}

export default async function ExploreTraditionsPage({
  params
}: {
  params: Promise<{locale: string}>;
}) {
