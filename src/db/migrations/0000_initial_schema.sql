...
ALTER TABLE "deities" ADD CONSTRAINT "deities_parent_deity_id_deities_id_fk" FOREIGN KEY ("parent_deity_id") REFERENCES "public"."deities"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "traditions" ADD CONSTRAINT "traditions_parent_tradition_id_traditions_id_fk" FOREIGN KEY ("parent_tradition_id") REFERENCES "public"."traditions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "scripture_sections" ADD CONSTRAINT "scripture_sections_parent_section_id_scripture_sections_id_fk" FOREIGN KEY ("parent_section_id") REFERENCES "public"."scripture_sections"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
